                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                                case R.id.home:
                                        ...
                                        startActivity(new Intent(MealActivity.this, HomeActivity.class));
                                        return true;
                                case R.id.diet:
                                        // Otwieranie DietActivity
                                        startActivity(new Intent(MealActivity.this, DietActivity.class));
                                        return true;
                                case R.id.trainingplan:
                                        // Otwieranie GymActivity
                                        startActivity(new Intent(MealActivity.this, GymActivity.class));
                                        return true;
                                case R.id.sleep:
                                        // Otwieranie SleepActivity
                                        startActivity(new Intent(MealActivity.this, SleepActivity.class));
                                        return true;
                                default:
                                        return false;
                        }
